...
> **技术能力不等于伦理许可。解密数据库是技术问题，拿导出的数据去解剖他人的私人对话是隐私侵犯。**

本工具赋予你导出自己聊天记录的能力。但这不意味着你可以对导出的数据为所欲为。以下是一些明确的边界：

### ❌ 不要做的事

- **不要对他人进行心理分析或人格画像。** 不要把他人的聊天记录交给 AI 做"依恋风格分析"、"沟通模式诊断"、"关系权力动态评估"——不管用的是戈特曼理论还是依恋理论。对方没有同意自己的私人对话被算法解剖。
- **不要将他人聊天记录上传到第三方 AI 平台。** 聊天记录一旦离开你的本地设备，就脱离了你的控制范围。
- **不要公开分享他人的聊天内容。** 即使是"匿名的"片段，上下文也足以被熟人识别。

### ✅ 可以做的事

- 备份和查看**你自己**的聊天记录
- 分析**你自己写的文字**（日记、笔记、发给自己的消息）
- 学习理解这些分析框架本身（用虚构/匿名示例）
- 导出数据用于**合法的个人用途**（证据保全、数据迁移等）

### 一个简单的自检

> **在拿一段对话做任何事之前，问自己：如果对方此刻站在我身后看着我操作，我会不会觉得尴尬或心虚？如果答案是"会"，就不要做。**
